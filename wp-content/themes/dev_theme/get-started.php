...
<style>
  ...
  label { margin-right: 15px; margin-top: 2px; }
  .clearnone { margin-top: 3px; }
  .req { color: red; font-weight: bold; }
  #get-started-container { min-height: 365px; }
  .formset { display: inline-block; margin-bottom: 8px; border-bottom: 1px solid #ddd; width: 100%; }

  /* required info */
  .required-info { border-top: 1px solid #d8d8d8; border-bottom: 1px solid #d8d8d8; padding: 25px 0 50px; margin: 25px 0; }
  .required-info label { font-size: 14px; margin-right: 5px; width: 55px; }
  .required-info .formset { clear: none; display: block; margin: 15px 0; border-bottom: 0; }
  .required-info input { margin-right: 30px; padding: 3px; }
  .when-event-label { width: 168px !important; }
  .event-type-label { width: 140px !important; }
  .required-info .radio-buttons input { margin-left: 30px; margin-right: 5px; }
  .required-info .radio-buttons label { width: auto !important; }
  .event-formset { margin-top: 25px !important; }
</style>
...
<div id="get-started-container">
  <form id="get-started" type="post" action="">
    <div class="required-info">
      ...
      <span class="formset">
        <label class="when-event-label" for="event_date">When is your event? <span class="req">*</span></label>
        <input name="email" type="text" alt="<?php echo ('m d Y') ?>" class="required" />
        <span><small> (if unknown, enter today's date)</small></span>
      </span>

      <div class="clear"></div>
      <span class="formset event-formset">
        <label class="event-type-label">What type of event?</label>
    ...
    <div id="form-contents">
      <div id="corporate" class="hidden event-form">
        <h3>Corporate Event Information</h3>
        <span class="formset">
      ...
      <div id="social" class="hidden event-form">
        <h3>Social Gathering Information</h3>
        <span class="formset">
    ...
    <p><span class="req">*</span> denotes required field.</p>
    <p class="error-msg"></p>
  </form>
</div>
...
<script>
  jQuery(function($){
    ...
    $('.event-form').find('.formset:nth-child(even)').addClass('shaded');
  });      
</script>
